...
DEFAULT_CONTINUOUS_DOCK_REWARD  = 500.0

# Step cost (per action vs per second)
DEFAULT_DISCRETE_STEP_COST      = -1.0
DEFAULT_CONTINUOUS_STEP_COST    = DEFAULT_DISCRETE_STEP_COST * DEFAULT_DT  # -0.1

# Collision penalty
DEFAULT_DISCRETE_COLLISION_PENALTY   = 5.0
DEFAULT_CONTINUOUS_COLLISION_PENALTY = DEFAULT_DISCRETE_COLLISION_PENALTY * DEFAULT_DT  # 0.5

# Wall proximity penalty coefficient
DEFAULT_WALL_THRESH                = 1.0
DEFAULT_DISCRETE_WALL_PENALTY_COEFF   = 20.0
DEFAULT_CONTINUOUS_WALL_PENALTY_COEFF = DEFAULT_DISCRETE_WALL_PENALTY_COEFF * DEFAULT_DT  # 2.0

# Progress reward coefficient
DEFAULT_DISCRETE_PROGRESS_COEFF      = 3.0
DEFAULT_CONTINUOUS_PROGRESS_COEFF    = DEFAULT_DISCRETE_PROGRESS_COEFF * DEFAULT_DT  # 0.3

# Turn penalty coefficient
DEFAULT_DISCRETE_TURN_PENALTY_COEFF     = 30.0
DEFAULT_CONTINUOUS_TURN_PENALTY_COEFF   = DEFAULT_DISCRETE_TURN_PENALTY_COEFF * DEFAULT_DT  # 3.0
